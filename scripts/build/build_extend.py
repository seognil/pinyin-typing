...
def build_extend(base_texts: set[str], char_levels: dict[str, int]) -> dict:
    phrase_map = json.loads(EXTEND_SOURCE_PATH.read_text(encoding="utf-8"))
    filters = {
        "invalid_text": 0,
        "invalid_pm": 0,
        "invalid_length": 0,
